...
export const inventoryApi = {
  ...
  equipItem: (itemId: string, itemType: 'equipment' | 'artifact' | 'consumable') => 
    api.post('/api/inventory/equip', { itemId, itemType }),
  unequipItem: (itemId: string, itemType: 'equipment' | 'artifact' | 'consumable') => 
    api.post('/api/inventory/unequip', { itemId, itemType }),
  useConsumable: (itemId: string) => 
    api.post('/api/inventory/use', { itemId }),
  dropItem: (itemId: string, itemType: 'equipment' | 'artifact' | 'consumable') => 
    api.post('/api/inventory/drop', { itemId, itemType }),
  sellItem: (itemId: string, itemType: 'equipment' | 'artifact' | 'consumable') => 
